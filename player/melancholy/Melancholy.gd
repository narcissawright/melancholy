...
# Shield
onready var shield = $BubbleShield # contains shield.active, a bool saying if shield is up or not

# Material
onready var material = $MelancholyModel/Armature/Skeleton/MeshInstance.get_surface_material(0)
...
# AnimationTree
onready var anim_tree = $MelancholyModel/AnimationTree
...
onready var skele = $MelancholyModel/Armature/Skeleton
